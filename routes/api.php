...
use App\Http\Controllers\Date\SubscriptionController as DateSubscriptionController;
use App\Http\Controllers\Date\NotificationController as NotificationController;
...
Route::prefix("/dates/")->name("dates.")->group(function () {
    Route::match(['get', 'post'], "subscription/create", [DateSubscriptionController::class, "create"])
...
Route::middleware(['auth:sanctum', 'ability:admin'])->group(function() {
    ...
    Route::prefix("/client/")->name("client.")->group(function () {
        Route::get('{uid}', [ClientController::class, "show"])->name("show");
        Route::post('', [ClientController::class, "store"])->name("store");
        Route::delete('{uid}', [ClientController::class, "destroy"])->name("destroy");
    });
});
...
Route::middleware(['auth:sanctum', 'ability:user'])->group(function() {
    ...
    Route::prefix("/dates/")->name("dates.")->group(function () {
        ...
        Route::get("subscription/data/{clientId}", [DateSubscriptionController::class, "getData"])
            ->name("subscription.data");
        Route::get("subscription/delete/{clientId}", [DateSubscriptionController::class, "delete"])
            ->name("subscription.delete");
        Route::get("subscription/exists/{clientId}", [DateSubscriptionController::class, "exists"])
            ->name("subscription.exists");
        Route::get("notify-all", [NotificationController::class, "notifyAll"])
            ->name("notify_all");
    });
