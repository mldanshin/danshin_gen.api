...
Route::middleware(['auth:sanctum', 'ability:user', "throttle: $throttle"])->group(function() {
    ...
    Route::prefix("/dates/")->name("dates.")->group(function () {
        ...
        Route::get("subscription/data/{personId}", [DateSubscriptionController::class, "getData"])
            ->name("subscription.data");
        Route::get("subscription/delete/{personId}", [DateSubscriptionController::class, "delete"])
            ->name("subscription.delete");
        Route::get("subscription/exists/{personId}", [DateSubscriptionController::class, "exists"])
