...
use App\Models\Person\Editor\Updated\Marriage as MarriageModel;
use App\Models\Person\Editor\Updated\Person as PersonModel;
...
final class PersonUpdated
{
    ...
    {
        $eloquentModel = PeopleEloquentModel::find($model->id);
        ...
        $personId = DB::transaction(
            function () use ($eloquentModel, $model) {
                ...
                $eloquentModel->birth_date = ($model->isLive === true) ? null : $model->birthDate?->string;
                $eloquentModel->birth_place = $model->birthPlace;
                $eloquentModel->death_date = $model->deathDate?->string;
