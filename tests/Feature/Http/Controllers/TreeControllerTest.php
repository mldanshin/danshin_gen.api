...
final class TreeControllerTest extends TestCase
{
    ...
    public function testGetModel200(string $personId, string $request, callable $expected): void
    {
        ...
        return [
            [
                ...
                "expected" =>
                    ...
                    ->has('family', fn ($json) =>
                        $json->has('person', fn ($json) => 
                            $json->where('id', 1)
                                ->where('surname', "Danshin")
                                ->where('oldSurname', null)
                                ->where('name', "Pavel")
                                ->where('patronymic', "Tikhonovich")
                                ->has('birthDate', fn ($json) => 
                                    $json->where('string', "1905-10-11")
                                        ->etc()
                                    )
                                ->has('deathDate', fn ($json) => 
                                    $json->where('string', "1986-02-04")
                                        ->etc()
                                    )
                                ->where('isPersonTarget', false)
                        )
                        ->has('marriage', 1)
                        ->has('marriage.0', fn ($json) => 
                            $json->where('id', 2)
                                ...
                                ->has('birthDate', fn ($json) => 
                                    $json->where('string', "1909-09-04")
                                        ->etc()
                                )
                                ->has('deathDate', fn ($json) => 
                                    $json->where('string', "1995-12-14")
                                        ->etc()
                                )
                                ->where('isPersonTarget', false)
                        )
                        ->has('children', 1)
                        ->has('children.0.person', fn ($json) => 
                            $json->where('id', 3)
                                ->where('surname', "Danshin")
                                ->where('oldSurname', null)
                                ->where('name', "Leonid")
                                ->where('patronymic', "Pavlovich")
                                ->has('birthDate', fn ($json) => 
                                    $json->where('string', "1950-01-23")
                                        ->etc()
                                )
                                ->where('deathDate', null)
                                ->where('isPersonTarget', true)
                        )
                        ->has('children.0.marriage.0', fn ($json) => 
                            $json->where('id', 4)
                                ->where('surname', "Danshina")
                                ...
                                ->has('birthDate', fn ($json) => 
                                    $json->where('string', "1952-09-17")
                                        ->etc()
                                )
                                ->has('deathDate', fn ($json) => 
                                    $json->where('string', "2021-08-21")
                                        ->etc()
                                )
                                ->where('isPersonTarget', false)
                        )
    ...
    public function testModel422(string $request): void
    {
    ...
    public function testModel404(string $personId, string $request): void
    {
    ...
    public function testGetModel401(): void
    {
    ...
    public function testGetImage200(string $personId, string $request): void
    {
    ...
    public function testImage422(string $request): void
    {
    ...
    public function testImage404(string $personId, string $request): void
    {
    ...
    public function testGetImage401(): void
    {
    ...
    public function testGetInteractiveImage200(string $personId, string $request): void
    {
        $response = $this->get(
    ...
    public function testImageInteractive422(string $request): void
    {
    ...
    public function testImageInteractive404(string $personId, string $request): void
    {
        $params = "&path_person=https://fake.fake/person&path_tree=https://fake.fake/tree
            &image_person=https://fake.fake/image/person&image_tree=https://fake.fake/image/tree";
        $response = $this->get(
    ...
    public function testGetImageInteractive401(): void
    {
    ...
    public function testGetToggle200(string $personId, string $request, callable $expected): void
    {
        ...
        return [
            [
                ...
                "expected" => 
                    ...
                    ->has('parentList', 2)
                    ->has('parentList.0', fn ($json) => 
                        $json->where('id', 1)
                            ->where('surname', "Danshin")
                            ->where('name', "Pavel")
                            ->where('patronymic', "Tikhonovich")
                    )
                    ->has('parentList.1', fn ($json) => 
                        $json->where('id', 2)
                            ->where('surname', "Danshina")
                            ->where('name', "Elizabeth")
                            ->where('patronymic', "Dmitrievna")
    ...
    #[DataProvider('toggle204Provider')]
    public function testToggle204(string $personId, string $request): void
    {
     ...
     * @return array[]
     */
    public static function toggle204Provider(): array
    {
        return [
            ["1", ""]
        ];
    ...
    public function testGetToggle401(): void
    {
    ...
    public function testToggle404(string $personId, string $request): void
    {
        $response = $this->get(route("tree.toggle", ["id" => $personId]) . $request, $this->getHeaderUserToken());
        $response->assertStatus(404);
    }
    ...
    public function testToggle422(string $request): void
    {
