...
final class PersonShowControllerTest extends TestCase
{
    ...
    public function testShow200(int $person, string $request, callable $expected): void
    {
        $disk = StorageFacade::fake("public");
        $this->seedStorage($disk);
        $this->setConfigDateTime("2023-08-21");
            ...
            [
                ...
                "expected" => 
                    ...
                    $json->where('id', 1)
                        ...
                        ->where('emails', null)
                        ->has('internet.0', fn ($json) => 
                            $json->where('url', "http://1.danshin.net")
                                ->where('name', "Internet1")
                        )
                        ->has('internet.1', fn ($json) => 
                            $json->where('url', "http://2.danshin.net")
                                ->where('name', "Internet2")
                        )
                        ->where('phones', null)
                        ->has('residences.0', fn ($json) => 
                            $json->where('name', "Kemerovo")
                            ->has('date', fn ($json) => 
                                $json->where('hasUnknown', false)
                                    ->where('isEmpty', false)
                        ...
                        ->has('residences.1', fn ($json) => 
                            $json->where('name', "Mosk")
                            ->etc()
                            ->has('date', fn ($json) => 
                                $json->where('hasUnknown', false)
                                    ->where('isEmpty', false)
                        ...
                        ->where('parents', null)
                        ->has('marriages.0.soulmate', fn ($json) =>    
                            $json->where('id', 2)
                        ...
                        ->has('photo.0', fn ($json) =>    
                            $json->where('order', 1)
                                ->where('fileName', "1.jpeg")
                                ->where('date', null)
                        )
                        ->has('photo.1', fn ($json) =>    
                            $json->where('order', 2)
                            ->where('fileName', "2.jpg")
                            ->has('date', fn ($json) => 
                                $json->where('hasUnknown', false)
                                    ->where('isEmpty', false)
    ...
    public function testShow404(?string $id, string $request): void
    {
        $this->setConfigFakeDisk();
    ...
    public function testShow422(?string $id, string $request): void
    {
        $this->setConfigFakeDisk();
