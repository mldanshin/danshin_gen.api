...
final class PersonStoredControllerTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_store200(array $request, callable $expected): void
    {
    ...
    public static function store200Provider(): array
    {
        return [
            [
                ...
                function (PersonStoredControllerTest $object, int $personId) {
    ...
    public function test_store401(): void
    {
        $response = $this->postJson(route('person.store'));
        $response->assertStatus(401);
    }

    public function test_store403(): void
    {
        $response = $this->postJson(
            route('person.store'),
