...
use App\Models\Eloquent\Telegram as TelegramEloquentModel;
...
final class PersonDeleteControllerTest extends TestCase
{
    ...
    public function testDelete200(string $id, array $photo): void
    {
        ...
        $this->assertCount(0, TelegramEloquentModel::where("person_id", $id)->get());
    ...
    public function testDelete404(string $id): void
    {
        $response = $this->deleteJson(
            route("person.destroy", ["person" => $id]),
            headers: $this->getHeaderAdminToken()
