...
final class FileSystemTest extends TestCase
{
    ...
    public function testExistsFileSuccess(PhotoFileSystem $fileSystem): void
    {
        ...
        $this->assertTrue(
            $fileSystem->existsFile($fileSystem->disk->path("photo/1/1.jpeg"))
        );
    }
    ...
    public function testGetFilesArchive(PhotoFileSystem $fileSystem): void {
        ...
        $this->assertEquals(
            [
                new FileArchive($fileSystem->disk->path("photo/1/1.jpeg"), "1/1.jpeg"),
                new FileArchive($fileSystem->disk->path("photo/1/2.jpg"), "1/2.jpg"),
                new FileArchive($fileSystem->disk->path("photo/1/3.png"), "1/3.png"),
                new FileArchive($fileSystem->disk->path("photo/2/3.png"), "2/3.png")
            ],
            $filesArchive
        );
    }
