...
class DateTest extends TestCase
{
    ...
    public function testCreateObjectSuccess(?string $year, ?string $month, ?string $day): void
    {
    ...
    public function testCreateObjectWrong(?string $year, ?string $month, ?string $day): void
    {
    ...
    public function testDecodeSuccess(?string $text, ?Date $expected): void
    {
    ...
    public function testDecodeWrong(?string $text): void
    {
        $this->expectException(DateException::class);
        Date::decode($text);
    }
    ...
    public function testEncode(?Date $date, ?string $expected): void
    {
    ...
    public function testCheckTextSuccess(string $text): void
    {
    ...
    public function testcheckTextWrong(string $text): void
    {
    ...
    public function testCheckSuccess(?string $year, ?string $month, ?string $day): void
    {
    ...
    public function testcheckWrong(?string $year, ?string $month, ?string $day): void
    {
    ...
    public function testHasUnknown(?string $year, ?string $month, ?string $day, bool $expected): void
    {
        $this->assertEquals(
            $expected,
    ...
    public function testIsEmpty(?string $year, ?string $month, ?string $day, bool $expected): void
    {
        $this->assertEquals(
            $expected,
    ...
    public function testString(?string $year, ?string $month, ?string $day, ?string $expected): void
    {
        $this->assertEquals(
            $expected,
